...
public class CustomSpinnerAdapter_SignIn extends BaseAdapter {
    Context context;
    //    String choose;
    String[] content;
    LayoutInflater inflter;

    public CustomSpinnerAdapter_SignIn(Context applicationContext,   String[] content) {
...
//        this.choose = choose;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = inflter.inflate(R.layout.custom_spinner_item2, null);
