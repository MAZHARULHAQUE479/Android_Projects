package com.example.expandablenavigationdrawerdemoo.datasource;
...
public class ExpandableListDataSource {
    ...
    public static Map<String, List<String>> getData(Context context) {
        ...
        List<String> actionFilms = Arrays.asList(context.getResources().getStringArray(R.array.Reports));
